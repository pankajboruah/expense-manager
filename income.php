...
$sum=0;
$income=monthStatsIncome($month, $year);
...
if(isset($_POST['yesterday']) and $_POST['yesterday']==1) {
    ...
    $income=dateStatsIncome($date,$month,$year);
...
//    die("@".$newTime1."@".$newTime2);
    $income=durationStatsincome($newTime1,$newTime2);
...
if(isset($_POST['showForMonth'])){
    ...
    $month=$exploded['0'];
    $year=$exploded['1'];
    $expense=monthStatsIncome($month, $year);
    $subHeading=$months[$month-1]." ".$year;
}

if(isset($_POST['showForYear'])){
    $year=$_POST['year'];
    $income=yearIncome($year);
    $subHeading=$year;
}
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="nav-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="income.php"><i class="fas fa-hand-holding-usd"></i> Income</a></li>
    ...
    <div id="left-sidebar" class="visible-xs-block">
        <ul>
            ...
            <div class="dropdown">
                <li onclick="menubtn('icon11','icon22')" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Duration <i id="icon11" class="fas fa-arrow-circle-down" style="display:inline"></i><i id="icon22" class="fas fa-arrow-circle-up" style="display:none"></i></li>

                <div id="accounts-drop" class="dropdown-menu" aria-labelledby="dropdownMenu2">            
                <form action="" method="post" style="width:90%;">
                    <input type="date" name="from" class="form-control" style="font-size:0.8em">
                    <input type="date" name="to" class="form-control" style="font-size:0.8em">
                    <button type="submit" name="showDuration" class="btn btn-success" style="margin-top:5px">Show</button>
                </form>
                </div>
            </div>
            <div class="dropdown">
                <li onclick="menubtn('icon33','icon44')" id="dropdownMenu3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Choose Date <i id="icon33" class="fas fa-arrow-circle-down" style="display:inline"></i><i id="icon44" class="fas fa-arrow-circle-up" style="display:none"></i></li>
            ...
            <div class="dropdown">
                <li onclick="menubtn('icon55','icon66')" id="dropdownMenu3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Choose Month <i id="icon55" class="fas fa-arrow-circle-down" style="display:inline"></i><i id="icon66" class="fas fa-arrow-circle-up" style="display:none"></i></li>
            ...
            <div class="dropdown">
                <li onclick="menubtn('icon77','icon88')" id="dropdownMenu3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Choose Year <i id="icon77" class="fas fa-arrow-circle-down" style="display:inline"></i><i id="icon88" class="fas fa-arrow-circle-up" style="display:none"></i></li>
        ...
        <div class="row box">
            ...
            <div class="col-lg-6 col-xs-12 legend">
                <div class="row">
                   <?php
                    foreach($income as $i) {
                        $c=category_data($i['category'], "icon", "title", "color", "type");
                    ?>
                        <div class="col-md-3 col-sm-3 col-xs-4 category" data-toggle="modal" data-target="#category<?php echo $i['category']; ?>">
                            <i class="<?php echo $c['icon']; ?>" style="color:<?php echo $c['color']; ?>"></i> 
                            <span><?php echo $c['title']; ?></span>
                        </div>
                        <!-- Modal -->
                         <div class="modal fade" id="category<?php echo $i['category']; ?>" role="dialog">
                              ...
                              <div class="modal-content" style="margin-top:2%;">
                                ...
                                <div class="modal-body">
                                    <table style="width:100%;">
                                        <thead>
                                            <tr>
                                                <th class="col1 inc-col1">Date and Time</th>
                                                <th class="col3 inc-col2">Account</th>
                                                <th class="col4 inc-col3">Amount</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            $inc_data=inc_category_data($i['category']);
                                            foreach($inc_data as $data) {
                                                $data_date=date("d M Y ", $data['timestamp']);
                                                $data_time=date(" h:i a", $data['timestamp']);
                                            ?>
                                                <tr>
                                                    <td class="col1 inc-col1"><span class="datetime"><?php echo $data_date; ?></span> - <span class="datetime"><?php echo $data_time; ?></span></td>
                                                    <td class="col3 inc-col2"><?php echo $data['account']; ?></td>
                                                    <td class="col4 inc-col3"><?php echo "<i class='fas fa-rupee-sign'></i>".$data['amount']; ?></td>
                                                </tr>
                                            <?php
                                            }
                                            ?>
           ...
           <?php
            foreach($income as $i) {
                ...
                if($sum==0) {
                    ...
                    $percent=round(($i['amount']/$sum)*100,1,PHP_ROUND_HALF_UP);
                }
            ?>
            <div class="col-sm-6 col-xs-12">
                <span style="font-weight:700;" class="info" data-toggle="modal" data-target="#category<?php echo $i['category']; ?>"><i class="<?php echo $c['icon']; ?>" style="font-size:2em;color:<?php echo $c['color']; ?>"></i> <?php echo $c['title']; ?></span>
