...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="nav-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="budget.php"><i class="fas fa-clipboard-check"></i> Budget Planner</a></li>
    ...
    <div class="container" id="content1">
        ...
        <h4 style="color:#777;text-align:center;font-weight:600;">Plan your monthly budget with Arbre Budget Planner.<br><br> (Absolutely free with Arbre Expense)</h4>
