...
<head>
    ...
    <title>ARBRE | Budget Planner</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="nav-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="billsplit.php"><i class="fas fa-columns"></i> Bill Spliter</a></li>
    ...
    <div class="container" id="content1">
        <h2>Bill Spliter</h2>
        <h4 style="color:#777;text-align:center;font-weight:600;">Split your expense/bill with your friends and group with Arbre Bill spliter. <br><br>(Absoluetly free with Arbre Expense.)</h4>
